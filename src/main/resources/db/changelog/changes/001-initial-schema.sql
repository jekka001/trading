...
--changeset btc-collector:1 author:system
--comment: Create btc_candle_15m table
...
--changeset btc-collector:2 author:system
--comment: Create btc_indicator_15m table
...
--changeset btc-collector:3 author:system
--comment: Create strategy_stats table
...
--changeset btc-collector:4 author:system
--comment: Create pending_prediction table
...
--changeset btc-collector:5 author:system
--comment: Create historical_pattern table
...
--changeset btc-collector:6 author:system
--comment: Create alert_history table
...
--changeset btc-collector:7 author:system
--comment: Create market_regime table
